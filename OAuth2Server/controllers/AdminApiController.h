...
class AdminApiController : public drogon::HttpController<AdminApiController>
{
  public:
    METHOD_LIST_BEGIN
    // Client Management
    ADD_METHOD_TO(AdminApiController::listClients, "/api/admin/clients", Get, "AuthorizationFilter");
    ADD_METHOD_TO(AdminApiController::createClient, "/api/admin/clients", Post, "AuthorizationFilter");
